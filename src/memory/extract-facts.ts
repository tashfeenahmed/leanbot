 ...
 * - "my flatmate Hamza" (relationship then name)
 * - "Hamza is my flatmate" (name then relationship)
 * - "Hamza, my flatmate" (name, comma, relationship - appositive)
 * - "my flatmates Hamza and Sara" (multiple subjects)
 */
function findThirdPartySubject(text: string): Map<number, string> {
  ...
  // Find "my flatmates Hamza and Sara" patterns (check first - more specific)
  ...
  // Find "Hamza, my flatmate" patterns (appositive)
